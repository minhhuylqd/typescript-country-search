...
export const fetchAllCountries = createAsyncThunk('countries/fetchAllCountries', async () => {
  try {
    const response = await fetch('https://restcountries.com/v3.1/all?fields=name,cca3,capital,region,subregion,languages,population,flags')
...
export const selectCountryEntities = (state: RootState) => state.countries.entities
